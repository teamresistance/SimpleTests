...
public class IO {
    ...
    // Drive
    public static CANVenom drvLead_R = new CANVenom(11);    // Cmds right wheels. Includes encoders
    public static CANVenom drvFollower_R = new CANVenom(12);// Resrvd 7 & 8 maybe
    public static CANVenom drvLead_L = new CANVenom(15);    // Cmds left wheels. Includes encoders
    ...
    // Snorfler
    // public static Spark snorfFeed_Mtr = new Spark(0);     //Feed motor on snorfler
    // public static Spark snorfElv_Mtrs = new Spark(1);     //Lower elevator motor
    ...
    // public static InvertibleDigitalInput lockPinBExt_B_FB = new InvertibleDigitalInput(4,true);
