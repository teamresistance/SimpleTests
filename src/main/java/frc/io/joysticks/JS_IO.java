...
public class JS_IO {
    ...
    public static Axis axCoDrvY = new Axis();       // Right JS Y
    public static Axis axCoDrvX = new Axis();       // Right JS X
    ...
    private static void norm3JS() {
        ...
        // shooting buttons
        axGoalSel.setAxis(coJoystick, 3);           //Slider, select low prs if < 0.1
